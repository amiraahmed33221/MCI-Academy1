...
import '../All Semester/Semester2/first_semester2m.dart';
import '../All Semester/Semester2/second_semester2m.dart';
import '../all_divisions2.dart';


class SecondDivision2 extends StatelessWidget {
  const SecondDivision2({super.key});
                ...
                children: [
                  TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => FirstSemester2M()),
                        );
                      },
