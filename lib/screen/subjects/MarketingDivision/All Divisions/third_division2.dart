...
import '../All Semester/Semester3/first_semester3m.dart';
import '../All Semester/Semester3/second_semester3m.dart';
import '../all_divisions2.dart';


class ThirdDivision2  extends StatelessWidget {
  const ThirdDivision2 ({super.key});
                ...
                children: [
                  TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => FirstSemester3M()),
                        );
                      },
                  ...
                  TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => SecondSemester3M()),
                        );
                      },
