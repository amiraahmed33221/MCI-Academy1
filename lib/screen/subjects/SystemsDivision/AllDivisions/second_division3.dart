...
import '../All Semester/Semester2/first_semester2s.dart';
import '../All Semester/Semester2/second_semester2s.dart';
import '../all_divisions3.dart';


class SecondDivision3 extends StatelessWidget {
  const SecondDivision3({super.key});
                ...
                children: [
                  TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => FirstSemester2S()),
                        );
                      },
                  ...
                  TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => SecondSemester2S()),
                        );
                      },
