...
import '../All Semester/Semester4/first_semester4s.dart';
import '../All Semester/Semester4/second_semester4s.dart';
import '../all_divisions3.dart';


class FourthDivision3  extends StatelessWidget {
  const FourthDivision3 ({super.key});
                ...
                children: [
                  TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => FirstSemester4S()),
                        );
                      },
                  ...
                  TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => SecondSemester4S()),
                        );
                      },
