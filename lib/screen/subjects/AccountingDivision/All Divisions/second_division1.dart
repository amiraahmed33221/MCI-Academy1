...
import '../Semester2/first_semester2.dart';
import '../Semester2/second_semester2.dart';
import '../all_divisions1.dart';
import 'first_division1.dart';


class SecondDivision1 extends StatelessWidget {
  const SecondDivision1({super.key});
        ...
        children: [
                  ...
                  TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => FirstSemester2()),
                        );
                      },
                  ...
                  TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => SecondSemester2()),
                        );
                      },
          ...
          ElevatedButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => SecondSemester2()),
              );
            },
