...
import '../screen3.dart';
import 'Accounting/all_accountingTable.dart';
import 'Marketing/all_marketing_table.dart';
import 'Systems/all_exam_systems.dart';

class AllExamShedule extends StatelessWidget {
  const AllExamShedule({super.key});
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => AllAccountingTable()),
                );
              },
              child: Container(
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => AllExamSystems()),
                );
              },
              child: Container(
                decoration: BoxDecoration(
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => AllMarketingTable()),
                );
              },
              child: Container(
                decoration: BoxDecoration(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 30,),
                    Image.asset("assets/marketing1.png",height: 150,width: 190,),
                  ],
                ),
              ),
            ),
